                        ...
                        @foreach($sliders as $slider)
                            <tr>
                                ...
                                <td class="center">
                                    ...
                                    src="{{$slider->slider_image}}" alt="{{$slider->slider_image}}">
                                </td>
                                ...
                                <td class="center">
                                    ...
                                    @endif
                                    <a class="btn btn-info" href="{{URL::to('/edit_slider/'.$slider->slider_id)}}">
                                        <i class="halflings-icon white edit"></i>  
                                    </a>
                                    <a class="btn btn-danger delete" href="{{URL::to('/delete_slider/'.$slider->slider_id)}}">
