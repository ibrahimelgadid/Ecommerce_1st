...
<ul class="breadcrumb">
    ...
    <li>
        <i class="icon-edit"></i>
        <a href="{{URL::to('/edit_manufacture')}}">edit_manufacture</a>
    </li>
</ul>
...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <form class="form-horizontal" method="POST" action="{{url('/update_manufacture',$manufacture->manufacture_id)}}">
          
                @csrf
              <fieldset>
                
                <div class="control-group">
                  <label class="control-label" for="manufacture name">manufacture Name</label>
                  <div class="controls">
