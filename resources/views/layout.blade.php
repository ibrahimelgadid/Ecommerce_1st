				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							...
							<li><a href="/show_cart"><i class="fa fa-shopping-cart"></i> Cart<span  style="
							background: #FE980F; color:white; padding:2px
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="manufacture_products"><!--manufacture_products-->
							<h2>Manufacture</h2>
							<div class="manufacture-name">
								<ul class="nav nav-pills nav-stacked">
									...
									?>
										<li><a href="{{URL::to('/product_by_manufacture/'.$manufacture->manufacture_id)}} " class="text-basic">{{$manufacture->manufacture_name}}</a></li>
									<?php }?>
								</ul>
							</div>
						</div><!--/manufacture_products-->
