    ...
    <div class="product-image-wrapper">
        <div class="single-products">
                <div class="productinfo text-center">
                    <img src="{{URL::to($product->product_image)}}" style="height:250px;width:300px" alt="" class="img-responsive" />
        ...
        <div class="choose">
            <ul class="nav nav-pills nav-justified">
                ...
                <li><a href="{{URL::to('view_product/'.$product->product_id)}}"><i class="fa fa-plus-square"></i>See details..</a></li>
            </ul>
        </div>
    </div>
</div>
