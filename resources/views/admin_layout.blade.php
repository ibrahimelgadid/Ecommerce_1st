			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all_category')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Categories</span></a></li>
						<li><a href="{{URL::to('/add_category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a></li>
						<li><a href="{{URL::to('/all_manufacture')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Manufactures</span></a></li>
						...
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="{{URL::to('/all_slider')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Sliders</span></a></li>
							</ul>	
						</li>
